...
sub getGoSize { 
    ...
    my $pstmt = $dbh->prepare("select TranscriptID, OntologyDomain, OntologyEvidenceCode from ontologies_int where  kblocusid like '$sname%' and OntologyID = ? and OntologyType = 'GO'");
