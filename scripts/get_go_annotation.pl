...
=head1 EXAMPLE
 ...
 echo "kb|g.3899.locus.192" | get_go_annotation 
 echo "kb|g.3899.locus.192" | get_go_annotation --evidence_code=IEA
...
MAN
	...
	print "\n";
	print "Examples: \n";
	print "echo 'kb|g.3899.locus.192,kb|g.3899.locus.2366' | get_go_annotation ";
	print "\n";
	print "\n";
